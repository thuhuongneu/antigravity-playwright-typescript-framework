...
- Name: auth/crm-login.spec.ts >> CRM Authentication - Login Tests >> TC_LOGIN_003: HTML5 validation khi email thiếu domain
- Location: src/tests/auth/crm-login.spec.ts:36:9
