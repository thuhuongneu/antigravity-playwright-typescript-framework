...
- Name: auth/crm-login.spec.ts >> CRM Authentication - Login Tests >> TC_LOGIN_002: HTML5 validation khi email không có @
- Location: src/tests/auth/crm-login.spec.ts:26:9
