...
- Name: auth/crm-login.spec.ts >> CRM Authentication - Login Tests >> TC_LOGIN_025: HTML5 validation email sai format trên Forgot Password
- Location: src/tests/auth/crm-login.spec.ts:203:9
...
Locator: locator('a[href*="forgot_password"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href*="forgot_password"]')
