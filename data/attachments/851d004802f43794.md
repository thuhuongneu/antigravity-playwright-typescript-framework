...
- Name: auth/crm-login.spec.ts >> CRM Authentication - Login Tests >> TC_LOGIN_023: HTML5 validation Forgot Password trống email
- Location: src/tests/auth/crm-login.spec.ts:183:9
